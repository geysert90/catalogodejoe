                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-3 width-23 mb-30">
                                <div className="mb-20">
                                <img src="/assets/imgs/template/logo-joesupply-preview.png" alt="Joe Supply" width="120" height="auto" />
                                </div>

                                <p className="font-xs mb-20 color-white">Somos una empresa mayorista de envio de contenedores a Cuba,
                                    ofrecemos los mejores precios , calidad , seguimiento y seguridad de su mercancía. </p>
                    ...
                    <div className="container">
                        <div className="footer-bottom">
                            <div className="row align-items-center">
                                <div className="col-lg-6 col-md-12 text-center text-lg-start"><span className="color-grey-300 font-md">© JoeSupply {new Date().getFullYear()}. Todos los derechos reservados.</span></div>
