      ...
      <div className="col-6 col-md-4">
        <div className="card h-100 shadow-sm bg-white hover-up">
          ...
          <div
            ...
            onClick={() => setShowModal(true)} // 👈 abre modal al click
          >
            {ofertaEspecial && (
              <div
                style={{
      ...
      {showModal && (
        ...
        >
          ...
          <img
            ...
            onClick={(e) => e.stopPropagation()} // 👈 no cerrar si clic en la imagen
          />
        </div>
      )}
    </>
            ...
            <div className="row">
              ...
              <div className="col-lg-9">
                <div className="d-flex flex-wrap align-items-center justify-content-between mb-3 gap-2">
                  ...
                  >
                    <Link
                      className={`btn btn-sm d-inline-flex align-items-center justify-content-center text-center ${!nat || nat === "mix" ? "btn-brand-1" : "btn-outline-secondary"}`}
                      href={{
                        pathname: "/tienda",
                        query: {
