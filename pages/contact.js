                            ...
                            <div className="row align-items-center">
                                <div className="col-xl-8 col-lg-7">
                                    <div className="box-contactform-left">
                                        <h3 className="color-brand-2 mb-15 wow animate__animated animate__fadeIn">Tienes alguna pregunta ?</h3>
                                        <p className="font-md color-grey-900 mb-50 wow animate__animated animate__fadeIn">¿No encuentras la respuesta que buscas? Habla con nuestro equipo.</p>
                                        <form action="#">
                                            <div className="row wow animate__animated animate__fadeIn">
                                                ...
                                                <div className="col-md-6">
                                                    <div className="form-group">
                                                        <input className="form-control" type="text" placeholder="Tu número de teléfono" />
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="form-group">
                                                ...
                                                <div className="col-md-12">
                                                    <div className="form-group">
                                                        <textarea className="form-control" placeholder="Mensaje / Nota" rows={8} defaultValue={""} />
                                                    </div>
                                                </div>
                                                <div className="col-md-12">
                                ...
                                <div className="col-xl-4 col-lg-5 position-relative">
                                    <div className="box-contactform-right">
                                        <h5 className="color-brand-2 mb-35 wow animate__animated animate__fadeIn">Oficina</h5>
                        <div className="map-info"><img className="mb-15" src="/assets/imgs/template/icons/joe-supply-embedded.svg" alt="Joe Supply" width="120" height="120" />
                                            ...
                                            <p className="color-grey-700 mb-10 wow animate__animated animate__fadeIn">
                                                ...
                                                </svg>Teléfono: +1 (561) 814‑0985 (Disponible 24/7)
                                            </p>
                                            <p className="color-grey-700 mb-30 wow animate__animated animate__fadeIn">
                                                ...
                                                </svg>Correo: joesupply@gmail.com
                                            </p>
                                            <div className="line-border mb-25" />
                                            <p className="color-grey-700 font-md-bold wow animate__animated animate__fadeIn">Horario: 8:00 - 17:00, Lun - Sab</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
